...
> 📖 **In English:** [../../en/03-framework-reference/project-hierarchy.md](../../en/03-framework-reference/project-hierarchy.md)
...
> ⭐ Самі ПРАВИЛА (нумерований звід «що не ламати») винесено в **[rules.md](rules.md)** — читай його разом із цим документом. Тут — ієрархія й маршрут; там — правила.
