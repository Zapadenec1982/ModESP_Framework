...
| **Portable chip driver** | `components/modesp_osd/` (`At7456e`, `Amt630a`) | raw SPI/I²C registers; **zero ModESP semantics** |
...
- **Cyrillic font:** loaded into FONT RAM (16×20 1bpp) — the chip's ROM font has no Cyrillic. Map: `components/modesp_osd/include/modesp/osd/amt630a_charmap.h`. Generated by `tools/gen_osd_font.py --target amt630a`.
