 ...
 *
 * ```cpp
 * auto* pid = new modesp::scenario::PidController();
 ...
 *
 * ```cpp
 * modesp::scenario::primitives::register_primitives();
...
/// Register all standard primitives into supplied ContinuousRegistry. Idempotent
